...
public:
  ...
  virtual void endVisit(ASTArrayDefaultExpr *element) override;
  virtual void endVisit(ASTArrayFixedExpr *element) override;
  virtual void endVisit(ASTNotExpr *element) override;
  virtual bool visit(ASTForIteratorStmt *element) override;
  virtual void endVisit(ASTForIteratorStmt *element) override;
