...
public:
  ...
  virtual bool visit(ASTArrayDefaultExpr *element) { return true; }
  virtual void endVisit(ASTArrayDefaultExpr *element) {}
  virtual bool visit(ASTArrayFixedExpr *element) { return true; }
  virtual void endVisit(ASTArrayFixedExpr *element) {}
  virtual bool visit(ASTNotExpr *element) { return true; }
  virtual void endVisit(ASTNotExpr *element) {}
  virtual bool visit(ASTForIteratorStmt *element) { return true; }
  virtual void endVisit(ASTForIteratorStmt *element) {}
